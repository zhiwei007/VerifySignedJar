...
public final class Streams {
     ...
     * @throws Exception 
     */
    public static void readFully(InputStream in, byte[] dst) throws Exception {
     ...
     * @throws Exception 
     */
    public static void readFully(InputStream in, byte[] dst, int offset, int byteCount) throws Exception {
        if (byteCount == 0) {
            return;
        }
        if (in == null) {
...
//        Arrays.checkOffsetAndCount(dst.length, offset, byteCount);
    ...
    public static void checkOffsetAndCount(int arrayLength, int offset, int count) throws Exception {
        if ((offset | count) < 0 || offset > arrayLength || arrayLength - offset < count) {
           throw new  Exception("checkOffsetAndCount invoked exception");
        }    
    }
    /**
